...
export enum NotificationType {
  ...
  PROJECT_COMPLETED_BY_BUSINESS = 'project_completed_by_business',
  ...
  ADDITIONAL_PAYMENT_APPROVED = 'additional_payment_approved',
  ADDITIONAL_PAYMENT_REJECTED = 'additional_payment_rejected',
  ADDITIONAL_PAYMENT_COMPLETED = 'additional_payment_completed',
...
export class NotificationService {
  ...
  getNotificationIcon(type: NotificationType): string {
    const icons = {
      ...
      [NotificationType.BUSINESS_SUSPENDED]: '⚠️',
      [NotificationType.BUSINESS_REACTIVATED]: '✅',
